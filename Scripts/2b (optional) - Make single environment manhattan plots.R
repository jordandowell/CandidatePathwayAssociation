...
suggthresh <-
  0.001 ## draw line at "suggestive" SNPs (threshold fraction of snips are above the blue line)

### easy map to allign the snips to
snp.map = fread(file = paste("Software/", SNPset, ".map", sep = ""),
                header = F) ###for easier plotting of snip locations
